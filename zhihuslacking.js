// ==UserScript==
// @name         知乎极简沉浸 - 纯净阅读与摸鱼防窥版
// @namespace    https://greasyfork.org/users/zhihu-minimal-stealth
// @version      6.1.1-mod
// @description  [个人修改版] 基于原作者 v6.1.1：宽屏自适应(1100px)、仅保留 Esc 老板键。全站去顶栏/侧栏/广告/看山/操作条；彻底消灭丑陋白底骨架屏；回答时间自动置顶；问答页黑底白字平铺；消灭知乎页签图标；评论详情与楼中楼弹窗全黑夜化；顶部极简搜索栏；图片模糊防窥；右侧4浮钮；配备1:1像素级高保真VS Code代码编辑器全屏掩护（按Esc或点击>_键触发）
// @author       You
